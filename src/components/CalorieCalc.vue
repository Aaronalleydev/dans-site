<template>
  ...
  <form @submit.prevent="getBmr" class="grid m-auto w-4/5">
    ...
    <input type="text" class="p-1 m-2 w-full text-center rounded-lg" required placeholder="Weight(KG)" name="weight" v-model="weight">
    <label class="text-gray-800 text-lg font-bold" for="height">Height</label>
    <input type="text" class="p-1 m-2 w-full text-center rounded-lg" required placeholder="Height(cm)" name="height" v-model="height">
    <label class="text-gray-800 text-lg font-bold" for="age">Age</label>
    <input type="text" class="p-1 m-2 w-full text-center rounded-lg" required placeholder="Age" name="age" v-model="age">

    <label class="text-gray text-lg font-bold" for="gender">Gender</label>
    <select class="bg-white p-1 m-2 w-full text-center rounded-lg" name="gender" id="gender" v-model="gender">
    ...
    <select class="bg-white p-1 m-2 w-full text-center rounded-lg" name="acitivity" id="activity" v-model="activity">
    ...
    <div v-if="bmr" class="bg-red-400 p-6 text-lg text-gray-800 flex flex-col justify-center rounded-br-xl rounded-bl-xl shadow-lg">
      ...
      <p class="p-2">Your daily calories is the amount of calories needed to maintain your current wait based off your current activity levels</p>
